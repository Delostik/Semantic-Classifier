...
{   
    ...
    public class DSSM_Train : DNN_Train
    {
        ...
        //public List<Layer_Output_Deriv_QD_PairTOP> Neg_QD_Pair_TOP = new List<Layer_Output_Deriv_QD_PairTOP>();
        ...
        //public List<CudaPieceInt> GPU_negative_index = new List<CudaPieceInt>();
        //public List<CudaPieceInt> GPU_Inver_negative_index = new List<CudaPieceInt>();
        //public List<CudaPieceInt> GPU_Inver_negative_value = new List<CudaPieceInt>();
        ...
        void Init(DNN dnn_query, DNN dnn_doc)
        {
            ...
            //{
            //    Neg_QD_Pair_TOP.Add(new Layer_Output_Deriv_QD_PairTOP(dnn_query, dnn_doc));
            //}
            ...
            for (int i = 0; i < ParameterSetting.NTRIAL; i++)
            {
                GPU_negative_index.Add(new CudaPieceInt(ParameterSetting.BATCH_SIZE, true, true));            
                GPU_Inver_negative_index.Add(new CudaPieceInt(ParameterSetting.BATCH_SIZE, true, true));
                GPU_Inver_negative_value.Add(new CudaPieceInt(ParameterSetting.BATCH_SIZE, true, true));
            }
            */
